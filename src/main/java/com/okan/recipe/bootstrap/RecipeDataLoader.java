...
public class RecipeDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        boterham.addIngredient(new Ingredient("Boterham", new BigDecimal(2), eachUom));
        boterham.addIngredient(new Ingredient("Pindakaas", new BigDecimal(1), eachUom));
        boterham.addIngredient(new Ingredient("Jam", new BigDecimal(1), eachUom));
